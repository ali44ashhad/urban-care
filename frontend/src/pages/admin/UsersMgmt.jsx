...
export default function UsersMgmt() {
  ...
  async function toggleStatus(id, current) {
    await adminService.toggleUserStatus(id, !current)
    loadUsers()
  }
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 sm:p-6">
      ...
      <Card className="p-4 mb-4">
        <div className="flex flex-col sm:flex-row gap-4">
          <div className="flex gap-2 flex-wrap">
            ...
            <FilterBtn active={filter === 'client'} onClick={() => setFilter('client')}>
              Clients ({clientCount})
            </FilterBtn>
            <FilterBtn
      ...
      {/* Table Header */}
      <div className="hidden md:grid grid-cols-12 px-4 py-2 text-sm font-semibold text-gray-600">
      ...
      {loading ? (
        ...
        <div className="space-y-2">
          {filteredUsers.map(user => (
            <div
              key={user._id || user.id}
              className="grid grid-cols-1 md:grid-cols-12 gap-4 items-center bg-white rounded-lg px-4 py-3 shadow-sm"
            >
              {/* User */}
              ...
              <div className="col-span-2 text-right">
                <button
                  onClick={() =>
                    toggleStatus(user._id || user.id, user.isActive)
                  }
