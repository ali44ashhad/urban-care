        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-400">
              Get Expert Professional Service at Home. Connecting you with trusted service providers for all your home care needs.
            </p>
            <div className="flex space-x-4">
              ...
              <a
                href="https://www.instagram.com/stunn_club?utm_source=qr&igsh=bDcxa3lpNG01eGxv"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://www.linkedin.com/company/stunnclub/"
                target="_blank"
                rel="noopener noreferrer"
